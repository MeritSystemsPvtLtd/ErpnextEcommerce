...
$.extend(shopping_cart, {
    ...
    bind_shipping_change: function() {
        $(".cart-shipping-rule").on("change", ".select-ship-rule", function() {
            var newVal = $(this).val();
            frappe.freeze();
            return frappe.call({
                type: "POST",
                method: "erpnext.shopping_cart.cart.change_in_shipping",
                args: {
                    shipp: newVal
                },
    ...
    payment_mode: function() {
        return frappe.call({
            type: "POST",
            method: "erpnext.shopping_cart.cart.get_payment_mode",
            callback: function(r) {
                if (r.message) {
    ...
    cart_shipping_rule: function() {
        return frappe.call({
            type: "POST",
            method: "erpnext.shopping_cart.cart.cart_shipping_rule",
            callback: function(r) {
                if (r.message) {
